const API_URL = "https://bloom-bevel-krypton.glitch.me/";
...
const createCard = (item) => {
    ...
    <img
        ...
        Alt="Коктейль ${API_URL}${item.title}" 
        class="cocktail__img">
    ...
    <div class="cocktail__content">
        <div class="cocktail__text">
            ...
            <p class="cocktail-price text-red">
                ${item.price}₽
            </p>
...
const modalController = ({ modal , btnOpen, time = 300, open , close}) => {
    ...
    const closeModal = (e) => {
        ...
        if (e === "close" || target === modalElem || code === "Escape") {
            modalElem.style.opacity = 0;
            
            setTimeout(() => {
                modalElem.style.visibility = 'hidden';
                scrollServise.enabledScroll();
                if (close) {
                    close();
                };
            }, time)
...
const calculateMakeYourOwn = () => {
    ...
    makeInputTitle = modalMakeOwn.querySelector(".make__input-title");
    ...
    makeAddBtn = modalMakeOwn.querySelector(".make__add-btn");
    ...
    const handlerChange = () => {
        ...
        makeTotalPrice.textContent = `${totalPrice} p`;
...
const calculateAdd = () => {
    ...
    const fillInForm = data => {
        ...
        makeTotalPrice.textContent = `${data.price} р`;
...
const createCartItem = (item) => {
    ...
    <img 
    class="order__img" 
    src="./images/header/goods/make-your-own.jpg" 
    alt="${item.title}">
